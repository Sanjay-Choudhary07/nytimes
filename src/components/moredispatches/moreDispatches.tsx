...
const MoreDispatches:React.FC<MoreDispatches>=(props)=>{
    ...
    useEffect(() => {
        ...
        if (props.text === "Dispatches" || props.text === "The Saturday Profile") {
            url = "https://api.nytimes.com/svc/topstories/v2/world.json?api-key=drOGzKhrS4itQI8JAlMOI21w58Ic8cAM";
        } else {
            url = `https://api.nytimes.com/svc/search/v2/articlesearch.json?q="${props.text.toLowerCase()}"&api-key=drOGzKhrS4itQI8JAlMOI21w58Ic8cAM`;
        }
